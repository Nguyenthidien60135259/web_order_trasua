...
@section('content')
    ...
    <div class="slider-item"><img src="http://127.0.0.1:8001/introducts/review2.jpg">
    ...
    <div class="one-half img" style="background-image: url(http://127.0.0.1:8001/introducts/story.jpg);"></div>
