  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 mb-5 ftco-animate">
        <a href="#" name="image" class="image-popup"><img src="http://127.0.0.1:8000/products/{{$products->image}}" class="img-fluid" alt="Colorlib Template"></a>
      </div>
      ...
      @foreach($type as $cm)
                <div class="media">
                    <a class="pull-left" href="#">
                        <img width="64px" height="64px" class="media-object" src="http://127.0.0.1:8000/introducts/user.png" alt="">
                    </a>
